...
function setupPasswordToggles() {
  ...
  passwordInputs.forEach(input => {
    ...
    btn.style.cssText = "position:absolute; right:10px; background:none; border:none; padding:4px; display:flex; align-items:center; justify-content:center; color:#32de84; cursor:pointer; z-index:10;";
